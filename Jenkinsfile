pipeline {
    ...
    stages {
        ...
        stage('checkout') {
            steps {
                echo "Checkouting...."
                git branch: 'Staging', credentialsId: 'github-credential', url: 'https://github.com/oraby88/cmsproject.git'      
        ...
        stage("Build Docker Image"){
            steps{
                ...
                sh 'docker build -t mmohei24/cms-frontend:$BUILD_NUMBER .'
            }
        }
        ...
        stage("Push Docker Image"){
            steps{
                ...
                sh 'docker push mmohei24/cms-frontend:$BUILD_NUMBER'
        ...
        stage('Delete Local Image') {
            steps {
                sh 'docker rmi mmohei24/cms-frontend:$BUILD_NUMBER'
