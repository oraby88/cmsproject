...
export class CardModalComponent {
  ...
  ngOnChange() {
    this.icon.nativeElement.style.backgroundImage = `${environment.BASEURL}assets/images/${this.backgroundImg}`;
    console.log(`${environment.BASEURL}assets/images/${this.backgroundImg}`
    );
  }
